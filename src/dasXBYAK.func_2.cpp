...
void Module_dasXBYAK::initFunctions_2() {
	...
	addExtern<DAS_CALL_METHOD(_method_70)>(*this,lib,"db",SideEffects::worstDefault,"das_call_member< void (Xbyak::CodeArray::*)(int) , &Xbyak::CodeArray::db >::invoke")
		->args({"self","code"});
	using _method_71 = das::das_call_member< void (Xbyak::CodeArray::*)(const unsigned char *,size_t),&Xbyak::CodeArray::db >;
	addExtern<DAS_CALL_METHOD(_method_71)>(*this,lib,"db",SideEffects::worstDefault,"das_call_member< void (Xbyak::CodeArray::*)(const unsigned char *,size_t) , &Xbyak::CodeArray::db >::invoke")
		->args({"self","code","codeSize"});
	using _method_72 = das::das_call_member< void (Xbyak::CodeArray::*)(unsigned long long,size_t),&Xbyak::CodeArray::db >;
	addExtern<DAS_CALL_METHOD(_method_72)>(*this,lib,"db",SideEffects::worstDefault,"das_call_member< void (Xbyak::CodeArray::*)(unsigned long long,size_t) , &Xbyak::CodeArray::db >::invoke")
		->args({"self","code","codeSize"});
	...
	addExtern<DAS_CALL_METHOD(_method_77)>(*this,lib,"getCurr",SideEffects::worstDefault,"das_call_member< const unsigned char * (Xbyak::CodeArray::*)() const , &Xbyak::CodeArray::getCurr >::invoke")
		->args({"self"});
	using _method_78 = das::das_call_member< size_t (Xbyak::CodeArray::*)() const,&Xbyak::CodeArray::getSize >;
	addExtern<DAS_CALL_METHOD(_method_78)>(*this,lib,"getSize",SideEffects::worstDefault,"das_call_member< size_t (Xbyak::CodeArray::*)() const , &Xbyak::CodeArray::getSize >::invoke")
		->args({"self"});
	using _method_79 = das::das_call_member< void (Xbyak::CodeArray::*)(size_t),&Xbyak::CodeArray::setSize >;
	addExtern<DAS_CALL_METHOD(_method_79)>(*this,lib,"setSize",SideEffects::worstDefault,"das_call_member< void (Xbyak::CodeArray::*)(size_t) , &Xbyak::CodeArray::setSize >::invoke")
		->args({"self","size"});
	...
	addExtern<DAS_CALL_METHOD(_method_80)>(*this,lib,"dump",SideEffects::worstDefault,"das_call_member< void (Xbyak::CodeArray::*)() const , &Xbyak::CodeArray::dump >::invoke")
		->args({"self"});
	using _method_81 = das::das_call_member< void (Xbyak::CodeArray::*)(size_t,unsigned long long,size_t),&Xbyak::CodeArray::rewrite >;
	addExtern<DAS_CALL_METHOD(_method_81)>(*this,lib,"rewrite",SideEffects::worstDefault,"das_call_member< void (Xbyak::CodeArray::*)(size_t,unsigned long long,size_t) , &Xbyak::CodeArray::rewrite >::invoke")
		->args({"self","offset","disp","size"});
	using _method_82 = das::das_call_member< void (Xbyak::CodeArray::*)(size_t,size_t,int,Xbyak::inner::LabelMode),&Xbyak::CodeArray::save >;
	addExtern<DAS_CALL_METHOD(_method_82)>(*this,lib,"save",SideEffects::worstDefault,"das_call_member< void (Xbyak::CodeArray::*)(size_t,size_t,int,Xbyak::inner::LabelMode) , &Xbyak::CodeArray::save >::invoke")
	...
	addExtern<DAS_CALL_METHOD(_method_88)>(*this,lib,"isOnlyDisp",SideEffects::worstDefault,"das_call_member< bool (Xbyak::Address::*)() const , &Xbyak::Address::isOnlyDisp >::invoke")
		->args({"self"});
	using _method_89 = das::das_call_member< size_t (Xbyak::Address::*)() const,&Xbyak::Address::getDisp >;
	addExtern<DAS_CALL_METHOD(_method_89)>(*this,lib,"getDisp",SideEffects::worstDefault,"das_call_member< size_t (Xbyak::Address::*)() const , &Xbyak::Address::getDisp >::invoke")
		->args({"self"});
	...
	addExtern<DAS_CALL_METHOD(_method_107)>(*this,lib,"set",SideEffects::worstDefault,"das_call_member< void (Xbyak::LabelManager::*)(Xbyak::CodeArray *) , &Xbyak::LabelManager::set >::invoke")
		->args({"self","base"});
	using _method_108 = das::das_call_member< void (Xbyak::LabelManager::*)(std::string),&Xbyak::LabelManager::defineSlabel >;
	addExtern<DAS_CALL_METHOD(_method_108)>(*this,lib,"defineSlabel",SideEffects::worstDefault,"das_call_member< void (Xbyak::LabelManager::*)(std::string) , &Xbyak::LabelManager::defineSlabel >::invoke")
		->args({"self","label"});
