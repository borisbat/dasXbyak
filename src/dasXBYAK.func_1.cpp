...
void Module_dasXBYAK::initFunctions_1() {
	...
	addExtern<DAS_CALL_METHOD(_method_62)>(*this,lib,"getScale",SideEffects::worstDefault,"das_call_member< int (Xbyak::RegExp::*)() const , &Xbyak::RegExp::getScale >::invoke")
		->args({"self"});
	using _method_63 = das::das_call_member< size_t (Xbyak::RegExp::*)() const,&Xbyak::RegExp::getDisp >;
	addExtern<DAS_CALL_METHOD(_method_63)>(*this,lib,"getDisp",SideEffects::worstDefault,"das_call_member< size_t (Xbyak::RegExp::*)() const , &Xbyak::RegExp::getDisp >::invoke")
		->args({"self"});
