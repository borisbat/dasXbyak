...
void Module_dasXBYAK::initFunctions_23() {
	...
	addExtern<DAS_CALL_METHOD(_method_2211)>(*this,lib,"vpbroadcastq",SideEffects::worstDefault,"das_call_member< void (Xbyak::CodeGenerator::*)(const Xbyak::Xmm &,const Xbyak::Reg64 &) , &Xbyak::CodeGenerator::vpbroadcastq >::invoke")
		->args({"self","x","r"});
	using _method_2212 = das::das_call_member< void (Xbyak::CodeGenerator::*)(size_t,bool),&Xbyak::CodeGenerator::align >;
	addExtern<DAS_CALL_METHOD(_method_2212)>(*this,lib,"align",SideEffects::worstDefault,"das_call_member< void (Xbyak::CodeGenerator::*)(size_t,bool) , &Xbyak::CodeGenerator::align >::invoke")
